...
#===================Python Variables=======================
menu_category = ["Tea & Coffee","Beverages","Fast Food","Nepali","Starters","Main Course","Dessert"]

menu_category_dict = {"Tea & Coffee":"1 Tea & Coffee.txt","Beverages":"2 Beverages.txt",
                "Fast Food":"3 Fast Food.txt","Nepali":"4 Nepali.txt",
...
root.title("Welcome to Doteli Cafe")
...
title_label = Label(title_frame, text="Doteli Cafe", 
